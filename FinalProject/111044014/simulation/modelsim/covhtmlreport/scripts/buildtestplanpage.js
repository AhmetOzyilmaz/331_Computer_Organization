...
/********************************** End Of row 0 -- hearders **********************************/	
	for (var r = 1; r < table.rows.length; r++) {
		...
		if (tmp == 1) {
			if (isExcluded) {
				newCell = document.createElement('TD');
				newCell.className = 'exclEven';
				newCell.innerHTML = "--";
				newRow.appendChild(newCell);
				
				newCell = document.createElement('TD');
				newCell.className = 'exclOdd';
				newCell.innerHTML = "--";
				newRow.appendChild(newCell);
			...
			if (isExcluded) {
				newCell = document.createElement('TD');
				newCell.className = 'exclTgTdCntrE';
				newCell.innerHTML = "Excluded";
				newRow.appendChild(newCell);
				
				newCell = document.createElement('TD');
				newCell.className = 'exclTgTdCntrO';
				newCell.innerHTML = "--";
				newRow.appendChild(newCell);
		...
		if ((tmp == 1) || (tmp ==2)) {
			newCell = document.createElement('TD');
			if (isExcluded) {
				newCell.className = 'exclcntreven';
			} else {
				newCell.className = 'cntreven';
			}
			...
			if(tmp2.length > TEXTAREA_COLS) {
				...
				if (isExcluded) {
					newElement.className = "exclOddTxtBox";
				} else {
