...
function init() {
	...
	while ((typeof start_sort != "undefined") && (start_sort == 0));
	...
	for(var table = 0; table < atomic_tables.length; table++) {
		...
		if((curr_table.rows[0].cells[0].innerHTML.search("Weighted Average:") != -1) || (curr_table.rows[0].cells[0].innerHTML.search("Auto-Weighted Average:") != -1)) {
